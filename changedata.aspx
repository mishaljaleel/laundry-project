<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="changedata.aspx.cs" Inherits="laundry.changedata" %>
...
<body>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style2">drycleaning&ironing</td>
            <td>
                <asp:TextBox ID="TextBox2" runat="server" Width="210px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style2">washing&ironing</td>
            <td>
